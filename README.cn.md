...
[![x-cmd/install — gitu Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/gitu.svg?lang=zh)](https://x-cmd.com/install/gitu)
...
- **上游仓库**: <https://github.com/altsem/gitu>
- **许可证**: MIT
...
- **Star**: 2,917 · **Fork**: 165 · **开放 issue**: 168 · **贡献者**: 50

## 累计统计

- **发布数**: 56 · **已合并 PR**: 205 · **开放 PR**: 15 · **已关闭 issue**: 123 · **开放 issue**: 45 · **提交数**: 1228
...
| last60d | 2026-07-26 | 0 | 6 | 3 | 0 | 1 | 7 |
| 90d | 2026-06-26 | 1 | 8 | 3 | 1 | 1 | 26 |
| last180d | 2026-03-28 | 2 | 13 | 5 | 4 | 7 | 35 |
| 360d | 2025-09-29 | 6 | 58 | 15 | 15 | 10 | 136 |
| last720d | 2024-10-04 | 21 | 114 | 15 | 43 | 27 | 346 |
...
gitu 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `gitu` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/gitu.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260924.yml` · 2026-09-24T04:54:00Z._
